...
def load_property_data():
    ...
    project = pd.read_csv(os.path.join(base_dir, "data/project.csv"))
    address = pd.read_csv(os.path.join(base_dir, "data/ProjectAddress.csv"))
    config = pd.read_csv(os.path.join(base_dir, "data/ProjectConfiguration.csv"))
    variant = pd.read_csv(os.path.join(base_dir, "data/ProjectConfigurationVariant.csv"))
